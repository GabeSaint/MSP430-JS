...
function showRegisters(){
      ...
      if(register[0] > -1){
        ...
        var negBitValue = Math.abs(register[0]);
        negBitValue = ~negBitValue + 1
        register0BitContents = negBitWise.toString(2);
      }
    ...
    // Show Decimal Value - for memory
      ...
      //do twos complement
        ...
        var negBitValue = Math.abs(mregister[0]);
        negBitValue = ~negBitValue + 1
        mregister0BitContents = negBitWise.toString(2);
      }
